...
const repairDb = () => {
  const parentNav = document.querySelector(
    ".popup-repair-types .nav-list-popup-repair"
  )
  const popupRepairTable = document.querySelector(
    ".popup-repair-types-content-table"
  )
  const popupRepairTypesTitle = document.querySelector(
    ".popup-repair-types .popup-repair-types-content__head-title"
  )
  const popupRepairDate = document.querySelector(
    ".popup-repair-types .popup-repair-types-content__head-date"
  )
