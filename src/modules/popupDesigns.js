...
const popupDesigns = () => {
    ...
    const sliderCounterContentCurrent = '#popup-designs-counter .slider-counter-content__current';
    ...
    sliderUniversal(`.popup-designs-slider__style1`, designRight, designLeft, sliderCounterContentCurrent);
    ...
    const getCurrentSlide = (targetTab) => {
        designsSliderArray.forEach((elem, index, array) => {
            ...
            if (designsListArray.indexOf(targetTab) === index) {
                ...
                document.querySelector('#popup-designs-counter .slider-counter-content__current').textContent = 1;
    ...
    document.querySelector('body').addEventListener('click', (event) => {
        ...
        if (target.closest('#nav-list-popup-designs') && target.matches('.designs-nav__item')) {
