...
const popupPortfolio = () => {
  const portfolioSlider = document.querySelectorAll(
    ".portfolio .portfolio-slider__wrapper .portfolio-slider__slide-frame"
  )
  const popupPortfolio = document.querySelector(".popup-portfolio")
  const popupPortfolioSlider = document.querySelectorAll(
    ".popup-portfolio .popup-portfolio-slider__slide"
  )
  const portfolioSliderMobile = document.querySelectorAll(
    ".portfolio .portfolio-slider-mobile .portfolio-slider__slide-frame"
  )
  const portfolioSliderMobileSlides = document.querySelector(
    ".portfolio .portfolio-slider-mobile"
  )
  ...
  const getCurrentPopupSlide = (targetSlide) => {
    popupPortfolioSlider.forEach((elem, index) => {
      ...
      if (
        childsSlider.indexOf(targetSlide) === index ||
