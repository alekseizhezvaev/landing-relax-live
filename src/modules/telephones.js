...
const telephones = () => {
    ...
    const headerPhoneAccord = document.querySelector('.header-contacts__phone-number-accord');
    const headerPhoneNumber = document.querySelector('.header-contacts__phone-number-accord .header-contacts__phone-number');

    const openNewNumberPhone = (btnArrow) => {
        btnArrow.classList.add('custom-header-contacts__arrow')
        headerPhoneAccord.classList.add('custom-header-contacts__phone-number-accord')
    ...
    const closeNewNumberPhone = (btnArrow) => {
        ...
        headerPhoneAccord.classList.remove('custom-header-contacts__phone-number-accord')
