...
const sliderPortfolioMobile = () => {
  const sliderMobile = document.querySelectorAll(
    ".portfolio-slider-mobile .portfolio-slider__slide-frame"
  )
  const slideCountPortfolioTotalSmall = document.getElementById(
    "slideCountPortfolioTotalSmall"
  )
  ...
  sliderUniversal(
    ...
    right,
    left,
    slideCountPortfolioCurrentSmall
  )
}
