...
const problems = () => {
  ...
  const iconAsBtns = document.querySelectorAll(
    ".tablet-hide .problems-item__icon"
  )
  const activeBtns = document.querySelectorAll(
    ".tablet-hide .problems-item__icon-inner"
  )
  ...
  iconAsBtns.forEach((iconBtn, index) => {
    ...
    iconBtn.addEventListener("mouseout", function () {
      ...
      if (currentPopup.classList.contains("custom-down-tooltip-item-popup")) {
        ...
        currentPopup.classList.contains("custom-up-problems-item-popup")
      ) {
